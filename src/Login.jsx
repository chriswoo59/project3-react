  ...
  return (
    ...
    <div className='max-w-[320px] mx-auto py-16'>
        ...
        <label htmlFor='prod-name' className='form-label' >
                    ...
                    <input type="text" required onChange={(e)=>setUserName(e.target.value)} className='p-3 my-2 rounded text-black'/> <br></br>
                    <label htmlFor='prod-name' className='form-label' >
                        Password:
                    </label>
                    <input type="text" required onChange={(e)=>setPassword(e.target.value)} className='p-3 my-2 rounded text-black'/> <br></br>
